<?php 
	...
	$consultores = $conn->query("select * from consultores order by id") or trigger_error($conn->error);
?>
<main class="maintable">
	<div class="container">
		<h3 class="headline">Gerenciamento do Consultores</h3>
		<div class="row" style="margin-bottom: 20px;">
			<div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 offset-md-6 offset-lg-8 offset-lg-8">
				<button type="button" class="btn btn-success btn-lg form-control" id="btn-add-consultores">
					<i class='fa fa-plus'></i> Novo consultor
				</button>		
			</div><!-- col-sm-8-->
		</div><!-- row -->	
			...
			<div class="col-12">
				<table class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
			        <thead>
			            <tr>
			                <th class='center'>#</th>
			                <th class="bigcolumn-title">Consultor</th>
			    	...
			    	<tbody>
						...
						?>
				        	<tr>
      							<th scope="row" class="center"><?php echo $consultor->id; ?></th>
      							<th scope="row" class="center"><?php echo $consultor->nome; ?></th>
						        <td><?php echo nl2br (substr ($consultor->descricao, 0, 100)); ?>...</td>
						        <?php if ($consultor->ativo == 0) { 
						        		$ativo ='Sim'; 
						      		} else { 
						      			$ativo ='Não';
						      	} 
						        ...
						        <td class='center'>									
									<a href="#" class="btn-edit-consultores" data-id="<?php echo $id;?>" alt="Editar Consultores <?php echo $consultor->id; ?>" title="Editar dados do consultor <?php echo $consultor->id; ?>">
										<i class="fa fa-edit fa-2x edit"></i>
									</a>
									<a href="#" class="btn-del-consultores" data-id="<?php echo $id;?>" alt="Remover consultor <?php echo $consultor->id; ?>" title="Remover consultor <?php echo $consultor->id; ?>">
...
<main class="mainform">
	<div class="container">
		<h3 class="headline">Gerenciar Consultores</h3>
			  			...
			  			<div class="col-12">
			  				<div class="checkbox">
								<label>
									...
									Se o evento está ativo, aparecerá na página consultores do site
								</label>
							</div>
			    		</div>
					</div>
