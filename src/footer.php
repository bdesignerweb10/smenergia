<div class="container-fluid">
		<div class="row footer">
			...
			<div class="col-sm-5">
				...
				<nav class="nav flex-column footer-menu">
				  <a class="nav-link nav-footer active footer-contato" href="#"><strong>Endereço:</strong> Rua 5, Nº 1258, sala 2, av 2 e 4, CEP 13500-180, Centro - Rio Claro/SP</a>
				  <a class="nav-link nav-footer footer-contato" href="#"><strong>Telefone:</strong> (19) 996443301 (Vivo) / (19)997108771 (Vivo)</a>
				  <a class="nav-link nav-footer footer-contato" href="#"><strong>E-mail:</strong> madeira@smenergia.com.br</a>	
